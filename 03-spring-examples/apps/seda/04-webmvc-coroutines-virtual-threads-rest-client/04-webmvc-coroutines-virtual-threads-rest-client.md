## Spring Boot app with Tomcat on Virtual Threads with Kotlin Coroutines
...
![seda_tomcat_virtual_threads.png](../../../../images/seda_tomcat_virtual_threads.png)
...
3. Run `SEDA_04_WebMVC_Coroutines_VirtualThreads`
