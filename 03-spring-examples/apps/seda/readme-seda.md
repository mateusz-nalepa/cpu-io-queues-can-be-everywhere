...
It's Thread Pool Stage Isolation pattern.

It has many thread pools, different stage of endpoint execution.
...
- [06-webflux-netty-server-client-netty-mongo.md](06-webflux-netty-server-client-netty-mongo/06-webflux-netty-server-client-netty-mongo.md)
